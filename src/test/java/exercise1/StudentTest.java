...
public class StudentTest {
    ...
    public void constructor_with_valid_parameters() {
        Student student = new Student("Stannis Baratheon", "012345", null);
    ...
    public void constructor_with_null_name() {
        assertThatThrownBy(() -> new Student(null, "012335", null))
            .isInstanceOf(NullPointerException.class);
    }

    @Test
    public void constructor_with_null_registration_number() {
        assertThatThrownBy(() -> new Student("Thyrion Lannister", null, null))
            .isInstanceOf(NullPointerException.class);
    }

    @Test
    public void setScore_with_less_than_0() {
        Student jonSnow = new Student("Jon Snow", "998877", null);
    ...
    public void setScore_with_more_than_20() {
        Student tywinLannister = new Student("Tywin Lannister", "002345", null);
    ...
    public void setScore_with_null_course() {
        Student gendry = new Student("Gendry", "225533", null);
    ...
    public void getScore_with_scored_course() {
        Student theonGreyjoy = new Student("Theon Greyjoy", "123654", null);
    ...
    public void getScore_with_unknown_course() {
        Student sansaStark = new Student("Sansa Stark", "425163", null);
    ...
    public void averageScore_with_many_courses() {
        Student daenarysTargaryen = new Student("Daenarys Targaryen", "028743", null);
    ...
    public void averageScore_with_no_course() {
        Student lorasTyrell = new Student("Loras Tyrell", "102039", null);
        assertThat(lorasTyrell.averageScore()).isEqualTo(0.0);
    }

    @Test
    public void bestCourse() {
        Student cerseiLannister = new Student("Cersei Lannister", "928657", null);
    ...
    public void bestScore() {
        Student aryaStark = new Student("Arya Stark", "987654", null);
    ...
    public void failedCourses() {
        Student joffreyBaratheon = new Student("Joffrey Baratheon", "208733", null);
    ...
    public void isSuccessful_with_average_score_12_and_2_failures() {
        Student davosSeaworth = new Student("Davos Seaworth", "123123", null);
    ...
    public void isSuccessful_with_average_score_10_and_1_failure() {
        Student jeorMormont = new Student("Jeor Mormont", "123123", null);
    ...
    public void isSuccessful_with_average_score_14_and_3_failures() {
        Student samwellTarly = new Student("Samwell Tarly", "334455", null);
    ...
    public void attendedCourses() {
        Student melisandre = new Student("Melisandre", "666999", null);
    ...
    public void attendedCourses_with_no_course() {
        Student gilly = new Student("Gilly", "666999", null);
        assertThat(gilly.attendedCourses()).isEmpty();
    }

    @Test
    public void getName() {
        Student shae = new Student("Shae", "554499", null);
        assertThat(shae.getName()).isEqualTo("Shae");
    }

    @Test
    public void getRegistrationNumber() {
        Student hodor = new Student("Hodor", "000321", null);
        assertThat(hodor.getRegistrationNumber()).isEqualTo("000321");
    }

    @Test
    public void equals_and_hashCode_with_same_name() {
        Student student1 = new Student("student", "123456", null);
        Student student2 = new Student("student", "456213", null);
    ...
    public void equals_and_hashCode_with_same_registration_number() {
        Student student1 = new Student("student1", "123456", null);
        Student student2 = new Student("student1", "123456", null);
